...
$stmt = $conn->prepare("SELECT status, waktu_mulai FROM sesi_pemilihan WHERE id_sesi = ?");
...
$waktu_mulai = $row_sesi['waktu_mulai'] ?? null;
...
<body>
    ...
    <div class="container2">
        <div class="container">
            <div class="header">
                ...
                <h1 class="title">Belum dimulai</h1>
                <p class="subtitle">Sedang menunggu mulai</p>
            </div>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            if (distance <= 0) {
                window.location.href = '/warga/votingkandidat/index.php';
            }
            if (distance < 0) {
